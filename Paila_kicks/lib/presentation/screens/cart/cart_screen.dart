...
import 'package:paila_kicks/logic/services/formatter.dart';
import 'package:paila_kicks/presentation/screens/order/order_detail_screen.dart';
      ...
      body: SafeArea(
        child: BlocBuilder<CartCubit, CartState>(builder: (context, state) {
          ...
          if (state is CartLoadedState && state.items.isEmpty){
            return const Center(
              child: Text("Oops.... The cart is empty"),
            );
          }
